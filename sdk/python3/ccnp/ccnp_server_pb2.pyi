...
class TcgImrEvent(_message.Message):
    __slots__ = ["imr_index", "event_type", "digest", "digests", "event_size", "event"]
    ...
    event_size: int
    event: bytes
    def __init__(self, imr_index: _Optional[int] = ..., event_type: _Optional[int] = ..., digest: _Optional[bytes] = ..., digests: _Optional[_Iterable[_Union[TcgDigest, _Mapping]]] = ..., event_size: _Optional[int] = ..., event: _Optional[bytes] = ...) -> None: ...

class GetCcEventlogResponse(_message.Message):
    __slots__ = ["event_logs"]
    EVENT_LOGS_FIELD_NUMBER: _ClassVar[int]
    event_logs: _containers.RepeatedCompositeFieldContainer[TcgImrEvent]
    def __init__(self, event_logs: _Optional[_Iterable[_Union[TcgImrEvent, _Mapping]]] = ...) -> None: ...
